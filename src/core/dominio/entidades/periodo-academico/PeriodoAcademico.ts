...
export class PeriodoAcademico implements IPeriodoAcademico {
    ...
    constructor(props: {
        ...
        if(props.fechaFin <= props.fechaInicio) throw new Error('La fecha de fin debe ser posterior a la de inicio');
    ...
    public activar(): void{
        if (this.estado === 'cerrado'){
            throw new Error('No se puede activar un periodo cerrado');
        };
   ...
   public cerrar(): void{
       if (this.estado === 'inactivo'){
           throw new Error('No se puede cerrar un periodo inactivo');
       };
       if (this.estado === 'cerrado'){
        return;
       }
